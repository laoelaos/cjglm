...
| **High** | 3 | S3 | round-trip 测试方法论薄弱：6/8 用例包含 round-trip 断言。身份 round-trip 无法捕获 quatCast 因子 2 bug；非身份 round-trip 可捕获（mat3Cast 不归一化已验证），但未针对性覆盖身份盲区 | `test_type_quat_cast.cj` |
