...
- `bitwiseNot()` 在 `VecN<Bool, Q>` 上可编译通过——`!` 对 `Bool` 执行逻辑非，语义与 C++ GLM 的 `~bvec` 一致。
...
// Vec1 + 标量组合
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>) where Q2 <: Qualifier
// 从 Vec1 填充全部分量
...
// Vec2 + 标量组合
public init<T2, Q2>(a: Vec2<T2, Q2>, b: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec2<T2, Q2>) where Q2 <: Qualifier
// Vec1 + 2 标量组合
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: T2, c: Vec1<T2, Q2>) where Q2 <: Qualifier
// 从 Vec1 填充全部分量
public init(v: Vec1<T, Q>)
```
...
public init<T2, Q2>(a: T2, b: Vec3<T2, Q2>) where Q2 <: Qualifier
...
// Vec2 + 2 标量组合
public init<T2, Q2>(a: Vec2<T2, Q2>, b: T2, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec2<T2, Q2>, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: T2, c: Vec2<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec2<T2, Q2>, b: Vec1<T2, Q2>, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec2<T2, Q2>, b: T2, c: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec2<T2, Q2>, c: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: Vec2<T2, Q2>, c: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: Vec2<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: Vec2<T2, Q2>) where Q2 <: Qualifier
...
// Vec1 + 3 标量组合
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: T2, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: T2, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: T2, c: Vec1<T2, Q2>, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: T2, c: T2, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: Vec1<T2, Q2>, c: T2, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: Vec1<T2, Q2>, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: T2, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: Vec1<T2, Q2>, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: T2, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: T2, c: Vec1<T2, Q2>, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: Vec1<T2, Q2>, c: Vec1<T2, Q2>, d: T2) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: Vec1<T2, Q2>, c: T2, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: Vec1<T2, Q2>, b: T2, c: Vec1<T2, Q2>, d: Vec1<T2, Q2>) where Q2 <: Qualifier
public init<T2, Q2>(a: T2, b: Vec1<T2, Q2>, c: Vec1<T2, Q2>, d: Vec1<T2, Q2>) where Q2 <: Qualifier
...
`DESIGN_WRITTEN:C:\Develop\Software\cjglm_wp\harness\redeliberations\202606170050_glm-migration-ood\a_v7_design_v2.md`
