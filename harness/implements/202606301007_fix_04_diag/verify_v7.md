...
error[0m: invalid binary operator '-' on type 'Enum-Option<Int32>' and 'Enum-Option<Int32>'
  ==> C:\Develop\Software\cjglm_wp\cjglm\src\gtc\ulp.cj:57:11:
   | 
57 |     abs(a - b)
   |           ^ 
   | 
   # note: you may want to implement 'operator func -(right: Enum-Option<Int32>)' for type 'Enum-Option<Int32>'

error[0m: invalid binary operator '-' on type 'Enum-Option<Int64>' and 'Enum-Option<Int64>'
  ==> C:\Develop\Software\cjglm_wp\cjglm\src\gtc\ulp.cj:65:11:
   | 
65 |     abs(a - b)
   |           ^ 
   | 
   # note: you may want to implement 'operator func -(right: Enum-Option<Int64>)' for type 'Enum-Option<Int64>'
...
warning[0m: unused import 'glm.detail.abs'
 ==> C:\Develop\Software\cjglm_wp\cjglm\src\gtc\ulp.cj:2:21:
  | 
2 | import glm.detail.{ abs }
  |                     ^^^ unused import
  | 
  # note: this warning can be suppressed by setting the compiler option `-Woff unused`
...
Error: failed to compile package `glm.gtc`, return code is 1
